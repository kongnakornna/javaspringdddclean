...
public class UpdateQuotationPartUseCase {
    private final QuotationPartService quotationPartService;
    public QuotationPartResponseDTO execute(UUID id, QuotationPartRequestDTO request) throws SystemGlobalException {
        return quotationPartService.updatePart(id, request);
    }
}

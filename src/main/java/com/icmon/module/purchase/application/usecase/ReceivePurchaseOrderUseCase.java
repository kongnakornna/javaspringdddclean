...
public class ReceivePurchaseOrderUseCase {
    ...
    public PurchaseOrderResponseDTO execute(UUID id, PurchaseOrderReceiveRequestDTO request) throws SystemGlobalException {
        return purchaseOrderService.receivePurchaseOrder(id, request);
    }
}

...
```mermaid
    graph TD
        A1[ลูกค้า Walk-in] --> B[สร้าง Job Card]
        A2[ลูกค้านัดหมายล่วงหน้า] --> B
        
        B --> C[วินิจฉัยอาการ / เพิ่มรายการซ่อม]
        C --> D[สร้างใบเสนอราคา Quotation]
        
        D --> E{ลูกค้าอนุมัติ?}
        
        E -- ไม่悦/แก้ไข --> F[ปรับปรุง Quotation / ยกเลิกงาน]
        F --> D
        
        E -- ใช่ --> G{ต้องสั่งอะไหล่เพิ่ม?}
        G -- ใช่ --> H[สร้าง Purchase Order]
        H --> I[เบิกอะไหล่เข้างาน]
        G -- ไม่/มีอะไหล่ในคลัง --> I
        
        I --> J[ดำเนินการซ่อม / บันทึกเวลา]
        J --> K[ตรวจสอบคุณภาพงาน QC]
        
        K -- ไม่ผ่าน --> J
        
        K -- ผ่าน --> L[สร้างใบแจ้งหนี้ Invoice]
        L --> M[รับชำระเงิน]
        M --> N[ออกใบเสร็จรับเงิน/ใบกำกับภาษี]
        N --> O[ปิด Job Card / ส่งมอบรถ]
```
